...
import type { ArticuloManufacturado, Categoria } from '../types/types'; // Importa los tipos necesarios
import ProductCard from '../components/products/ProductCard'; // Importa el componente de tarjeta de producto
