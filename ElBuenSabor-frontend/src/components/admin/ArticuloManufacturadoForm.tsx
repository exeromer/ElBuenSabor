  ...
  const handleAddDetalle = () => {
    setFormData((prev) => ({
      ...
      manufacturadoDetalles: [
        ...
        { articuloInsumoId: insumos[0]?.id || 0, cantidad: 1, estadoActivo: true },
      ],
    }));
  };
          ...
          {loadingOptions ? (
            ...
            <>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select
                  name="unidadMedidaId"
                  value={formData.unidadMedidaId || ''} // Usamos el ID directamente en el DTO
                  onChange={handleChange}
                  required
                    ...
                    formData.manufacturadoDetalles.map((detalle, index) => (
                      <ListGroup.Item key={index}>
                        <Row className="align-items-center">
                          <Col xs={12} md={6}> {/* Usar md para responsividad */}
                            <Form.Group className="mb-3 mb-md-0"> {/* Ajuste de margen para responsividad */}
                            ...
                            <Form.Group className="mb-3 mb-md-0">
                              ...
                              <InputGroup>
                                <Form.Control
                                  ...
                                  required
                                />
                                {/* Muestra la unidad de medida del insumo seleccionado */}
                                <InputGroup.Text>
                          ...
                          <Col xs={4} md={2} className="d-flex justify-content-end align-items-end">
                            <Button variant="danger" size="sm" onClick={() => handleRemoveDetalle(index)} className="mb-3 mb-md-0">
                              <FontAwesomeIcon icon={faMinusCircle} /> Eliminar
                            </Button>
                          </Col>
                        </Row>
                      </ListGroup.Item>
